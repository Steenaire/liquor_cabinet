...
RecipeIngredient.create!([
  ...
  {ingredient_id: 1, recipe_id: 73, quantity: "2.0", garnish: false, brand_id: 2, measurement: "volume (oz)"},
  {ingredient_id: 24, recipe_id: 73, quantity: "0.5", garnish: false, brand_id: 2, measurement: "volume (oz)"},
  {ingredient_id: 25, recipe_id: 73, quantity: "0.25", garnish: false, brand_id: 2, measurement: "volume (oz)"},
  {ingredient_id: 13, recipe_id: 73, quantity: "0.75", garnish: false, brand_id: 2, measurement: "volume (oz)"},
  {ingredient_id: 6, recipe_id: 73, quantity: "1.0", garnish: true, brand_id: 2, measurement: "count"},
...
Rating.create!([
  ...
  {user_id: 11, recipe_id: 72, score: 1},
  {user_id: 11, recipe_id: 52, score: 2},
  {user_id: 11, recipe_id: 53, score: 3},
  {user_id: 11, recipe_id: 54, score: 4},
  {user_id: 12, recipe_id: 73, score: 5}
])
TimelineDrink.create!([
  {user_id: 6, recipe_id: 1, comment: nil, image: nil},
  {user_id: 7, recipe_id: 2, comment: nil, image: nil},
  {user_id: 7, recipe_id: 52, comment: nil, image: nil},
  {user_id: 7, recipe_id: 1, comment: nil, image: nil},
  {user_id: 7, recipe_id: 4, comment: nil, image: nil},
  {user_id: 7, recipe_id: 62, comment: nil, image: nil},
  {user_id: 7, recipe_id: 1, comment: nil, image: nil},
  {user_id: 7, recipe_id: 1, comment: nil, image: nil},
  {user_id: 7, recipe_id: 57, comment: "Absolutely delicious! Would make again. Only suggestion is to garnish with a lemon twist.", image: nil},
  {user_id: 1, recipe_id: 57, comment: "Tasty and refreshing. Would make again!", image: nil},
  ...
  {user_id: 3, recipe_id: 57, comment: "", image: nil},
  ...
  {user_id: 12, recipe_id: 73, comment: "Delicious, I love how the sweetness is balanced by the tartness is balanced by the complexity of this drink.", image: nil}
])